...
const faqs = [
  ...
  },
  {
    ...
    a: "PayPayで購入した場合、購入完了時にライセンスキーが表示されます。Squareで購入した場合、(1)メールでライセンスキーが届く、(2)届かない場合はPremiumモーダルの「Squareで購入したがメールが届かない場合」で決済時のメールアドレスを入力してキーを取得できます。別のブラウザでは、取得したキーを「ライセンスキーをお持ちの方」欄に入力して「有効化」を押してください。",
  },
  {
    q: "返金はできますか？",
