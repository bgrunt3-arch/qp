...
const faqs = [
  ...
  },
  {
    ...
    a: "PayPayで購入した場合、購入完了時にライセンスキー（QP-XXXX-XXXX）が発行されます。別のブラウザや端末では、Premiumモーダルの「ライセンスキーをお持ちの方」欄にキーを入力して「有効化」を押すと利用できます。Squareで購入した場合も同様にライセンスキーが発行されます（Webhook設定が必要です）。",
  },
  {
    q: "返金はできますか？",
